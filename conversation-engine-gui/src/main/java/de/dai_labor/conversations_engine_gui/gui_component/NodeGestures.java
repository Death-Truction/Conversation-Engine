package de.dai_labor.conversations_engine_gui.gui_component;
...
public class NodeGestures {
	...
	DialogModelPane canvas;

	public NodeGestures(DialogModelPane dialogModelPane) {
		this.canvas = dialogModelPane;

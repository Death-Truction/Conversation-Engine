...
import de.dai_labor.conversation_engine_core.skills.WeatherSkillWithEmptyResponseAndQuestions;
import de.dai_labor.conversation_engine_core.skills.WeatherSkillWithNullTransitionTrigger;
import de.dai_labor.conversation_engine_core.skills.WeatherSkillWithWrongTransitionTrigger;
...
class WeatherSkillTest {
	...
	void wrongTrigger() {
		...
		this.myStateMachine = new ConversationEngine(this.nlp, defaultLanguage);
		String weatherSkillStateMachine = TestHelperFunctions.loadJsonFileAsString("Weather.json");

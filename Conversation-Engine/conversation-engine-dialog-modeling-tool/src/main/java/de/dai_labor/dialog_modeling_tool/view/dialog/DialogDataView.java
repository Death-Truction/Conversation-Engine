...
/**
 * The DialogData collects the information required to create the skill's
 * state machine model
 *
 * @author Marcel Engelmann
 *
 */
public class DialogDataView implements FxmlView<DialogDataViewModel>, Initializable {

	@InjectViewModel
	private DialogDataViewModel viewModel;
	@FXML

...
/**
 * The ViewModel for the {@link DialogDataView}
 *
 * @author Marcel Engelmann
 *
 */
@Singleton
public class DialogDataViewModel implements ViewModel, IStorableGuiData {
	...
	/**
	 * Creates a new DialogDataViewModel
	 *
	 * @param dialogViewModel The {@link DialogViewModel} instance
	 */
	public DialogDataViewModel(DialogViewModel dialogViewModel) {
		this.allStates = dialogViewModel.getStates();
		...
		this.selectedStartStateProperty.addListener(change -> {
			...
			dialogViewModel.setStartState(this.selectedStartStateProperty.get());
		...
		this.selectedEndStateProperty.addListener(change -> {
			...
			dialogViewModel.setEndState(this.selectedEndStateProperty.get());
			if (this.selectedStartStateProperty.get() != null
